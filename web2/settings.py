...
not_sae = not environ.get("APP_NAME", "")
if not_sae:
...
SECRET_KEY = 'q(6)%*e@6-kguu2k+zx7@m7biqcpl-(6@4rq%b=a)h-@#y^+^t'
...
UPGRADE_URL = 'static/upgrade/'

UPGRADE_ROOT = os.path.join(BASE_DIR, '/static/upgrade/')
