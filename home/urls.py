...
urlpatterns = patterns('home.views',
                       ...
                       url(r'^gcs/theme/restore/(?P<id>\d+)/',  'gcs_theme_restore_handle', name='gcs_theme_restore_handle'),
                       ...
                       url(r'^gcs/plugin/restore/(?P<id>\d+)/',  'gcs_plugin_restore_handle', name='gcs_plugin_restore_handle'),
